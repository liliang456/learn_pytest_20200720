...
def write_case_yml(har_path,depend=None):
    """
    循环读取导出文件
...
if __name__ == '__main__':
    pat = r'F:/pythoncode/learn_pytest_20200720/data/'
    print(write_case_yml(pat, depend='123'))